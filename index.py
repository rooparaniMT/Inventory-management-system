...
def LoginForm():
    global lbl_result
    TopLoginForm = Frame(loginform, width=800, height=100, bd=1, relief=SOLID)
    TopLoginForm.pack(side=TOP, pady=20)
    lbl_text = Label(TopLoginForm, text="Administrator Login", font=('arial', 20), width=800)
    lbl_text.pack(fill=X)
    MidLoginForm = Frame(loginform, width=800)
...
def AddNewForm():
    ...
    lbl_productname = Label(MidAddNew, text="Product Name:", font=('arial', 30), bd=20)
    lbl_productname.grid(row=0, sticky=W)
    lbl_qty = Label(MidAddNew, text="Product Quantity:", font=('arial', 30), bd=20)
    lbl_qty.grid(row=1, sticky=W)
    lbl_price = Label(MidAddNew, text="Product Price:", font=('arial', 30), bd=20)
    lbl_price.grid(row=2, sticky=W)
    productname = Entry(MidAddNew, textvariable=PRODUCT_NAME, font=('arial', 30), width=25)
    productname.grid(row=0, column=1)
    productqty = Entry(MidAddNew, textvariable=PRODUCT_QTY, font=('arial', 30), width=25)
    productqty.grid(row=1, column=1)
    productprice = Entry(MidAddNew, textvariable=PRODUCT_PRICE, font=('arial', 30), width=25)
    productprice.grid(row=2, column=1)
    btn_add = Button(MidAddNew, text="Save", font=('arial', 25), width=30, bg="#009ACD", command=AddNew)
...
def ViewForm():
    ...
    lbl_text = Label(TopViewForm, text="View Products", font=('arial', 25), width=600)
    lbl_text.pack(fill=X)
    ...
    btn_search.pack(side=TOP, padx=20, pady=20, fill=X)
    btn_reset = Button(LeftViewForm, text="Reset", command=Reset)
    btn_reset.pack(side=TOP, padx=20, pady=20, fill=X)
    btn_delete = Button(LeftViewForm, text="Delete", command=Delete)
    btn_delete.pack(side=TOP, padx=20, pady=20, fill=X)
